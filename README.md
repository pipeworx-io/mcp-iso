...
```bash
curl -X POST https://gateway.pipeworx.io/v1/tools/search_standards \
  -H 'Content-Type: application/json' \
  -d '{"query":"supply chain security"}'
```

No account needed for the first calls. Inspect any tool: `GET https://gateway.pipeworx.io/v1/tools/search_standards`. Find one: `POST https://gateway.pipeworx.io/v1/tools/search_packs` with `{"query":"..."}`.
